...
/*datasheetten aþaðýdaki hexler bakýlabilir */
...
//Gerekli bilgiler Datasheette mevcut
//P7............P0 is data that will be sent to lcd through i2c module(PCF8574);
//P0 : RS
//P1 : RW
//P2 : E
//P3 : BT -->Arkaplan ýþýðý kontrol biti
//P4 : D4
//P5 : D5
//P6 : D6
//P7 : D7
...
#define LCD_RW     0x02
#define LCD_E      0x04
#define LCD_BL_ON  0x08 //Backlight on 0b00001000
#define LCD_BL_OFF 0x00 //Backlight off 0b00000000
